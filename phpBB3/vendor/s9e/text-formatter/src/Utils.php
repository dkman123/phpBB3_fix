...
abstract class Utils
{
	...
	public static function removeFormatting($xml)
	{
		...
		// DK ***
		if ($dom->documentElement !== NULL) return $dom->documentElement->textContent;
		else return $dom->firstChild->textContent;
	}
	...
	protected static function saveXML(DOMDocument $dom)
	{
		...
		if ($dom->documentElement !== NULL)
			...
			return self::encodeUnicodeSupplementaryCharacters($dom->saveXML($dom->firstChild));
	}
